...
import TshirtTwo from '/public/images/tshirt-2.jpg'
import Category from './(dynamic)/products/category/[id]/page'


export default function Home() {

  const data = "women's%20clothing";
  ...
  return ( <> 
    <div className='container mx-auto px-4 flex items-center gap-24 min-h-screen my-16 min-[320px]:flex-col-reverse md:flex-col-reverse lg:flex-row'>
      ...
      <div className='flex flex-1 flex-col gap-12 mx-3'>
        ...
        <Link href={"/products"} className='p-5 bg-pink-400 border-none rounded-md w-max text-white uppercase font-semibold tracking-widest'>Shop Now</Link>
      </div>

      <div className='flex flex-col gap-12 w-full h-104 object-contain'>
        <Image src={Hero} alt='Sifo Shop' />
      </div>
    </div>
 ...
 <section className="dark:bg-gray-800 dark:text-gray-100">
	<div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
		<div>
			...
			<p className="max-w-3xl mx-auto mt-4 text-xl text-center dark:text-gray-400">We excel in many aspects that you will now discover.</p>
		</div>
		<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
			<div>
				<h3 className="text-2xl font-bold tracki sm:text-3xl dark:text-gray-50">Features of our services</h3>
				<p className="mt-3 text-lg dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita mollitia asperiores, deserunt temporibus quidem esse.</p>
				<div className="mt-12 space-y-12">
					<div className="flex">
						...
						<div className="ml-4">
							<h4 className="text-lg font-medium leadi dark:text-gray-50">Credibility</h4>
							<p className="mt-2 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita mollitia asperiores, deserunt temporibus quidem esse.</p>
						</div>
					</div>
					<div className="flex">
						<div className="flex-shrink-0">
						...
						<div className="ml-4">
							<h4 className="text-lg font-medium leadi dark:text-gray-50">Delivery to your door</h4>
							<p className="mt-2 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita mollitia asperiores, deserunt temporibus quidem esse.</p>
						</div>
					</div>
					<div className="flex">
						...
						<div className="ml-4">
							<h4 className="text-lg font-medium leadi dark:text-gray-50">Paiement when recieving</h4>
							<p className="mt-2 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita mollitia asperiores, deserunt temporibus quidem esse.</p>
						</div>
					</div>
				</div>
			...
			<div aria-hidden="true" className="mt-10 lg:mt-0">
					<Image src={Tshirt} className="mx-auto w-96 rounded-lg shadow-lg dark:bg-white" />
			</div>
		</div>
		<div>
			<div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
				<div className="lg:col-start-2">
					<h3 className="text-2xl font-bold tracki sm:text-3xl dark:text-gray-50"> 
						<font _mstmutation="1">What we aspire to</font>
					</h3>
					<p className="mt-3 text-lg dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita mollitia asperiores, deserunt temporibus quidem esse.</p>
					<div className="mt-12 space-y-12">
						<div className="flex">
							...
							<div className="ml-4">
								<h4 className="text-lg font-medium leadi dark:text-gray-50">best price</h4>
								<p className="mt-2 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita mollitia asperiores, deserunt temporibus quidem esse.</p>
							</div>
						</div>
						<div className="flex">
							...
							<div className="ml-4">
								<h4 className="text-lg font-medium leadi dark:text-gray-50">Delivering our services to the world</h4>
								<p className="mt-2 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita mollitia asperiores, deserunt temporibus quidem esse.</p>
							</div>
						</div>
						<div className="flex">
							...
							<div className="ml-4">
								<h4 className="text-lg font-medium leadi dark:text-gray-50">Quality of products</h4>
								<p className="mt-2 dark:text-gray-400">
									<font _mstmutation="1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita mollitia asperiores, deserunt temporibus quidem esse.</font> 
								</p>
							</div>
						</div>
					</div>
				</div>
				<div className="mt-10 object-contain lg:mt-0 lg:col-start-1 lg:row-start-1">
					<Image src={TshirtTwo} className="mx-auto w-96 rounded-lg shadow-lg dark:bg-white" />
				</div>
			</div>
		</div>
	</div>
